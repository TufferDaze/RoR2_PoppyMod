...
namespace PoppyMod.Modules
{
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(PoppyPlugin.instance.Info.Location), bundleName));
                //assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(PoppyPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
            catch (System.Exception e)
            {
                ...
                /*try
                {
                    assetBundle = AssetBundle.LoadFromFile("./" + bundleName);
                }
                catch
                {
                    Log.Error($"Error loading asset bundle, {bundleName}. Bundle cannot be found.");
                }*/
            }
